...
#import CSV files
Dose1 = pd.read_csv("Dose_Response_Ethanol_Daf2.csv")
print(Dose1)
...
plt.plot(polyline, mod53(polyline), color='k', label = '50mins')
...
plt.legend()
plt.grid() 
plt.title('Dose Response Curve for Daf-2 Strain in Ethanol Induced Stress')
plt.show()
